...
/**
 * This DataTypeConverter is used to Convert a Short Value into the Character Datatype by normally using the convert
 * method.
 * 
...
public class ShortToCharacterDatatypeConverter implements DatatypeConverter<Short, Character> {
  ...
  /**
   * Method converts the passed Short object to a Character.
   * 
   * @param pInput is the value which will be converted into the Character datatype.
   * @return {@link Character} Character object to which the passed Short was converted. The method returns null in the
   * case the pInput is null.
   */
  public final Character convert( Short pInput ) {
