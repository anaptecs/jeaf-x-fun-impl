...
/**
 * This DataTypeConverter is used to Convert a Double Value into the String Datatype by normally using the convert
 * method.
 * 
 * @author JEAF Development Team
 * 
 */
public class DoubleToStringDatatypeConverter implements DatatypeConverter<Double, String> {
  /**
  ...
  /**
   * Method converts the passed Double object to a String.
   * 
   * @param pInput is the value which will be converted into the String datatype.
   * @return {@link String} String object to which the passed Double was converted. The method returns null in the case
   * the pInput is null.
   */
  public final String convert( Double pInput ) {
