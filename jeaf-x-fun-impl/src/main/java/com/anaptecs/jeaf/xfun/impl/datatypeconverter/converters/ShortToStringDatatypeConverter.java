...
/**
 * This DataTypeConverter is used to Convert a Short Value into the String Datatype by normally using the convert
 * method.
 * 
...
public class ShortToStringDatatypeConverter implements DatatypeConverter<Short, String> {
  ...
  /**
   * Method converts the passed Integer object to a Short.
   * 
   * @param pInput is the value which will be converted into the String datatype.
   * @return {@link String} String object to which the passed Short was converted. The method returns null in the case
   * the pInput is null.
   */
  public final String convert( Short pInput ) {
