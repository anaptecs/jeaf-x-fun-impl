...
/**
 * This DataTypeConverter is used to Convert a Character Value into the String Datatype by normally using the convert
 * method.
 * 
...
public class CharacterToStringDatatypeConverter implements DatatypeConverter<Character, String> {
  ...
  /**
   * Method converts the passed Character object to a String.
   * 
   * @param pInput is the value which will be converted into the String datatype.
   * @return {@link String} String object to which the passed Character was converted. The method returns null in the
   * case the pInput is null.
   */
  public final String convert( Character pInput ) {
