...
/**
 * This DataTypeConverter is used to Convert a Long Value into the String Datatype by normally using the convert method.
 * 
...
public class LongToStringDatatypeConverter implements DatatypeConverter<Long, String> {
  ...
  /**
   * Method converts the passed Long object to a String.
   * 
   * @param pInput is the value which will be converted into the String datatype.
   * @return {@link String} String object to which the passed Long was converted. The method returns null in the case
   * the pInput is null.
   */
  public final String convert( Long pInput ) {
